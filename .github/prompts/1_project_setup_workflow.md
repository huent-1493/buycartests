...
5. **Page Objects Foundation** (`components/page_generator.md`)
...
**Use Optimized Test Generator** (`3_test_generation_workflow.md`)

- Fast test case generation for established projects
- Support both MD specification input and MCP web exploration
...
**Execute Final Review** (`4_code_review_standards.md`)
...
- ✅ Complete adherence to `4_code_review_standards.md` standards
...
**For Test Generation (Daily):**

```prompt
Generate tests using 3_test_generation_workflow.md:

- Target: [site/component/feature]
- Input: [MD spec file OR URL for exploration]
- Test type: [validation/functional/integration]
```

**For Code Review (After Generation):**

```prompt
Review generated code using 4_code_review_standards.md:
